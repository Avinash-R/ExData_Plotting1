...
## plotting a X-Y plot with line type and then annotating on obtained graph
...
legend("topright", lty = 1, col = c("black","red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), y.intersp=0.3)
